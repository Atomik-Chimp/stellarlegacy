...
SUBDIRS = stellarlegacy 

EXTRA_DIST = stellarlegacy.kdevprj AUTHORS COPYING ChangeLog INSTALL README TODO stellarlegacy.lsm acinclude.m4.in stellarlegacy.doxygen JOBS 
...
#>+ 4
KDE_DIST=pre-build subdirs configure.in.in configure.files 
